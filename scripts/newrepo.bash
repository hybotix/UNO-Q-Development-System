...
#
# Clones the UNO-Q repo and UNO-Q-Development-System repo fresh,
# copies Arduino apps and bin commands to $HOME, copies secrets to
# each app that needs them, and creates versioned symlinks for all
# bin commands.
#
...
DEV_REPO_DEST="$HOME/Repos/GitHub/hybotix/UNO-Q-Development-System"
...
git clone $DEV_REPO $DEV_REPO_DEST

cp -rp $REPO_DEST/Arduino $HOME
cp -rp $DEV_REPO_DEST/bin $HOME
